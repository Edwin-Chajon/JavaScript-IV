...
class GameObject {
    constructor(playerObjects){
    this.createdAt = playerObjects.createdAt;
    this.name = playerObjects.name;
    this.dimensions = playerObjects.dimensions
    }
    destroy(){
